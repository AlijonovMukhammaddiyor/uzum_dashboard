    ...
    >
      ...
      >
        <p className='w-full py-4 text-center text-base font-semibold'>
          {i18n.language === 'uz'
            ? "Quyidagi jadvalda oxirgi 7 kun ichida eng ko'p daromad keltirgan mahsulotlar ro'yhati keltirilgan"
            : 'В таблице ниже представлен список товаров, которые за последние 7 дней принесли наибольшую выручку'}
        </p>
        <Table
