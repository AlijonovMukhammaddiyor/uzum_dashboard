...
const Footer1 = () => {
  ...
  return (
    <footer className='text-black-100  flex  flex-col border-t border-gray-200'>
      ...
      <div className='mt-10 flex flex-wrap items-center justify-between border-t border-gray-200 px-6 pt-10 sm:px-16'>
        <p>
      ...
      <div className='mt-10 items-center justify-between border-t border-gray-200 px-6 py-10 text-center leading-snug tracking-wide sm:px-16 md:text-left'>
