...
const CountingDown = ({ discountEndDate }: any) => {
  ...
  return (
    <>
      ...
      <div
        className={clsxm(
          'absolute -right-10 top-10 z-[2000] flex h-[150px] flex-col items-center justify-center  space-y-4 rounded-lg bg-purple-300 px-4 shadow-2xl transition-all duration-500',
          !isCenter
